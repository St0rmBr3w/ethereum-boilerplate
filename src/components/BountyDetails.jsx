...
function BountyDetails({ closeModal }) {
  return (
    //*Modal Background*//
    <div
      className="z-10 absolute bg-slate bg-opacity-75 flex items-center justify-center h-full"
      onClick={() => closeModal(false)}
    >
      {/*Modal Container*/}
      <div className="z-20 relative opacity-100 bg-white flex-col items-center content-center justify-center w-3/4 p-10 my-20 mx-50 rounded-3xl overflow-auto">
        {/*Bounty Title*/}
        <div className="text-black m-10">
          {/*Task title*/}
          <span className="text-4xl font-bold mx-10">
            Create a new logo for UCSD's Foundation
          </span>
          <br></br>
          <br></br>
          {/*Task tags*/}
          ...
          <div className="m-10">
            ...
            <span className="text-base">
              The UC San Diego Foundation fosters and promotes community support 
              for UCSD to: Encourage donations for its educational, scientific, and public service programs. 
              Assist other programs that benefit UCSD. Advise the chancellor on issues that affect the community 
              and UC San Diego. Our logo needs to reflect our mission and represent our wonderful community on and off campus.
              We would love to see how you would improve our logo, specifically in creating a range of assets for marketing purposes.
            </span>
          </div>
          ...
          {/*Black bar divider*/}
          <hr className="bg-slate w-full h-2 rounded-lg m-10"></hr>
          ...
          <div className="flex m-10">
            <div className="border-slate border-4 w-72 h-36 rounded-xl mr-6 py-5 px-2">
              ...
              <span className="mx-2 my-5">
                <b>Email:</b> jane@sterling@ucsd.edu
              </span>
              <br></br>
              <span className="mx-2 my-5">
                <b>Website:</b> https://foundation.ucsd.edu/
              </span>
            </div>
            {/*Bounty Funder*/}
